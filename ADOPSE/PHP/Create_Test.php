...
//                        try
//                            {
                        $quizesq = "INSERT INTO quizes (title, sdesc, topic, idcreator) VALUES (?, ?, ?, ?);";
                        $qq = $conn->prepare($quizesq);
                        $qq->execute([$title, $shortdesc, $topic, $user->ID]);
//                            }
//                        catch (Exception $ex)
//                            {
//                                $genError = $ex;
                ...
                elseif ($_POST["buttonpressed"]=='Update')
                    {
                            ...
                            && $fwdonlyok && $neggradeok && $timelimitok && $shortdescok)
                        {
                            ...
                            //                        try
                            //                            {
                            $quizupdt = "UPDATE quizes SET title=?, sdesc=?, topic=? WHERE id=?";
                            $qu= $conn->prepare($quizupdt);
                            $qu->execute([$title, $shortdesc, $topic, $quizid]);
                            //                            }
                            //                        catch (Exception $ex)
                            //                            {
                            //                                $genError = $ex;
